...
export async function POST(req: NextRequest) {
  try {
    ...
    const { email, password, name, role, position, department, access_level, permissions, work_schedule, office_assets, phone, nic, join_date, contract_type, monthly_salary, employee_status } = body
